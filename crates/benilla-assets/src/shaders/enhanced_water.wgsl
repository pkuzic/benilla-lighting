...
// seamless). Dry (`wet0.x == 0`), WMO interior pools, interior-fog rooms, and pixels too far or too
...
fn rain_ripple_normal(world_xz: vec2<f32>, footprint: f32, distance: f32, room: bool) -> vec2<f32> {
    let wet0 = water_monkey().wet_a;
    let rain = clamp(wet0.x, 0.0, 1.0);
